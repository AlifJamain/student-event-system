...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Utama</a><i class="fa fa-angle-right"></i>Urus Penyertaan</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
                    ...
                    $sql = "SELECT f.FacultyId, f.FacultyName from tblfaculty as f where f.FacultyId=:FacultyId";
                    $query = $dbh -> prepare($sql);
...
{				?>
                        Fakulti: <?php echo htmlentities($result->FacultyName);?>
                            <?php $cnt=$cnt+1;} }?></h2>
					    <table id="table">
						<thead>
						  <tr>
...
<?php 
    ...
    $sql ="SELECT u.UserId, u.EmailId, u.FullName, u.FacultyId, u.MobileNumber, u.RegDate, b.status, b.CancelledBy, b.UpdationDate, b.uid, b.BookingId as bookid, b.PackageId, p.PackageId, f.FacultyId FROM tblusers as u join tblbooking as b on u.UserId=b.uid join tblpackages as p on b.PackageId=p.PackageId join tblfaculty as f on u.FacultyId=f.FacultyId where f.FacultyId=:FacultyId and p.PackageId=:PackageId ";
$query = $dbh -> prepare($sql);
$query -> bindParam(':FacultyId', $FacultyId, PDO::PARAM_STR);
