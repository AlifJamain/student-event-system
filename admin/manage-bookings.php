...
$query -> execute();
	echo "<script>alert('Tempahan Telah Ditolak');</script>";
...
$query -> execute();
echo "<script>alert('Tempahan Telah Diterima');</script>";
echo "<script type='text/javascript'> document.location = 'manage-faculty.php'; </script>";
}
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Urus Tempahan</h2>
						...
						<tbody>
<?php $sql = "SELECT tblbooking.BookingId as bookid,tblusers.FullName as fname, tblusers.UserId,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tblpackages.PackageName as pckname,tblbooking.PackageId as pid,tblbooking.status as status,tblbooking.CancelledBy as cancelby,tblbooking.UpdationDate as upddate from tblusers join  tblbooking on  tblbooking.uid=tblusers.UserId join tblpackages on tblpackages.PackageId=tblbooking.PackageId";
$query = $dbh -> prepare($sql);
$query->execute();
...
{
echo "Ditolak Oleh " .$result->upddate;
} 
