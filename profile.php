...
$query->execute();
$msg="Profil Pengguna Berjaya Dikemaskini";
}
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Profil Pengguna</h3>
